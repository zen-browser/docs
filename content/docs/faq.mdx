...
Zen Browser currently lacks DRM-support, because it does not have a Widevine license. This means that DRM-protected media cannot be played in Zen Browser for the foreseeable future.
